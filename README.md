...
Issues are generated by detectors when problems are detected:
...
-   **playout-discrepancy**: Audio/video playout mismatch
...
monitor.resolveActiveIssues("custom-problem", (issue) => issue.payload.severity === "high");
```
